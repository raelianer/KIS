<?php
	...
	session_start();
  	include 'head2.html';
    		echo '<li><a href=\'anzeigen.php?PHPSESSID='.session_id().'\'>Formular aufrufen</a></li>';
      		echo '<li><a href=\'erzeugen.php?PHPSESSID='.session_id().'\' style="background-color:#b0c4de;">Formular erzeugen</a></li>';
