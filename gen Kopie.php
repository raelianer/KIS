...
$sql = "INSERT INTO `obiwan11880`.`users` (`userid`, `rollenid`, `username`, `password`, `firstname`, `lastname`) VALUES (NULL, '1', 'mueller', 'abc', 'Hans', 'Müller');";
$result = $db->query($sql)
...
$sql = "INSERT INTO `obiwan11880`.`patient` (`patientid`, `firstname`, `lastname`, `birth`, `formularid`) VALUES (NULL, 'Bernd', 'Bäcker', '1960-02-10', NULL);";
$result = $db->query($sql)
